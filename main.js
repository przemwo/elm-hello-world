...
var author$project$Main$saveNewComment = function (model) {
		...
		switch (msg.$) {
			...
			case 'UpdateComment':
				...
				return _Utils_update(
					...
					{newComment: comment});
			default:
				return author$project$Main$saveNewComment(model);
		}
	});
var author$project$Main$SaveComment = {$: 'SaveComment'};
var author$project$Main$UpdateComment = function (a) {
...
var author$project$Main$viewComments = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Events$onSubmit(author$project$Main$SaveComment)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onInput(author$project$Main$UpdateComment)
							]),
						_List_Nil),
						A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$Main$viewComments(model)
					]))
			]));
};
